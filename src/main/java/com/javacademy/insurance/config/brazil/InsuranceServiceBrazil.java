...
import com.javacademy.insurance.config.japan.InsuranceCalcJapanService;
...
import static com.javacademy.insurance.enums.Country.BRAZIL;
import static com.javacademy.insurance.enums.Currency.REAL;
...
public class InsuranceServiceBrazil implements InsuranceService {
    ...
    public InsuranceContract insuranceOffer(BigDecimal coverageAmount,
        ...
        return new InsuranceContract(contractNumber,
                calcServicePrice, coverageAmount, REAL, clientsFullName,
                BRAZIL, typeInsurance, UNPAID_CONTRACT);
    }
